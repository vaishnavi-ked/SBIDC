...
!function (e, t) {
  ...
  _E.fn = _E.prototype = {
    ...
    var e,
      ...
      u = arguments.length,
      l = !1;
    for ("boolean" == typeof a && (l = a, a = arguments[s] || {}, s++), "object" == _typeof(a) || b(a) || (a = {}), s === u && (a = this, s--); s < u; s++) if (null != (e = arguments[s])) for (t in e) r = e[t], "__proto__" !== t && a !== r && (l && r && (_E.isPlainObject(r) || (i = Array.isArray(r))) ? (n = a[t], o = i && !Array.isArray(n) ? [] : i || _E.isPlainObject(n) ? n : {}, i = !1, a[t] = _E.extend(l, o, r)) : void 0 !== r && (a[t] = r));
    return a;
  }, _E.extend({
    ...
    makeArray: function makeArray(e, t) {
      var n = t || [];
      return null != e && (d(Object(e)) ? _E.merge(n, "string" == typeof e ? [e] : e) : u.call(n, e)), n;
    },
    ...
    guid: 1,
    support: m
  }), "function" == typeof Symbol && (_E.fn[Symbol.iterator] = t[Symbol.iterator]), _E.each("Boolean Number String Function Array Date RegExp Object Error Symbol".split(" "), function (e, t) {
  ...
  _E.find = p, _E.expr = p.selectors, _E.expr[":"] = _E.expr.pseudos, _E.uniqueSort = _E.unique = p.uniqueSort, _E.text = p.getText, _E.isXMLDoc = p.isXML, _E.contains = p.contains, _E.escapeSelector = p.escape;
  var h = function h(e, t, n) {
    ...
    N = _E.expr.match.needsContext;
  function S(e, t) {
    return e.nodeName && e.nodeName.toLowerCase() === t.toLowerCase();
  }
  var k = /^<([a-z][^\/\0>:\x20\t\r\n\f]*)[\x20\t\r\n\f]*\/?>(?:<\/\1>|)$/i;
  function D(e, n, r) {
    return b(n) ? _E.grep(e, function (e, t) {
  ...
  _E.filter = function (e, t, n) {
    ...
    find: function find(e) {
      ...
      if ("string" != typeof e) return this.pushStack(_E(e).filter(function () {
        for (t = 0; t < r; t++) if (_E.contains(i[t], this)) return !0;
      }));
      for (n = this.pushStack([]), t = 0; t < r; t++) _E.find(e, i[t], n);
      return 1 < r ? _E.uniqueSort(n) : n;
    },
    ...
    is: function is(e) {
      return !!D(this, "string" == typeof e && N.test(e) ? _E(e) : e || [], !1).length;
    }
  });
  var L,
    j = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
  (_E.fn.init = function (e, t, n) {
    ...
    if (n = n || L, "string" == typeof e) {
      ...
      if (r[1]) {
        if (t = t instanceof _E ? t[0] : t, _E.merge(this, _E.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : w, !0)), k.test(r[1]) && _E.isPlainObject(t)) for (r in t) b(this[r]) ? this[r](t[r]) : this.attr(r, t[r]);
        return this;
      }
      return (i = w.getElementById(r[2])) && (this[0] = i, this.length = 1), this;
    }
    return e.nodeType ? (this[0] = e, this.length = 1, this) : b(e) ? void 0 !== n.ready ? n.ready(e) : e(_E) : _E.makeArray(e, this);
  }).prototype = _E.fn, L = _E(w);
  ...
  _E.fn.extend({
    ...
    closest: function closest(e, t) {
      ...
      if (!N.test(e)) for (; r < i; r++) for (n = this[r]; n && n !== t; n = n.parentNode) if (n.nodeType < 11 && (a ? -1 < a.index(n) : 1 === n.nodeType && _E.find.matchesSelector(n, e))) {
        o.push(n);
        break;
      }
      return this.pushStack(1 < o.length ? _E.uniqueSort(o) : o);
    },
    index: function index(e) {
      return e ? "string" == typeof e ? i.call(_E(e), this[0]) : i.call(this, e.jquery ? e[0] : e) : this[0] && this[0].parentNode ? this.first().prevAll().length : -1;
    },
    ...
    contents: function contents(e) {
      return null != e.contentDocument && r(e.contentDocument) ? e.contentDocument : (S(e, "template") && (e = e.content || e), _E.merge([], e.childNodes));
    }
  }, function (r, i) {
    _E.fn[r] = function (e, t) {
      var n = _E.map(this, i, e);
      return "Until" !== r.slice(-5) && (t = e), t && "string" == typeof t && (n = _E.filter(t, n)), 1 < this.length && (O[r] || _E.uniqueSort(n), q.test(r) && n.reverse()), this.pushStack(n);
    };
  });
  var H = /[^\x20\t\r\n\f]+/g;
  function I(e) {
  ...
  _E.Callbacks = function (r) {
    var e, n;
    r = "string" == typeof r ? (e = r, n = {}, _E.each(e.match(H) || [], function (e, t) {
      n[t] = !0;
    }), n) : _E.extend({}, r);
    var i,
      t,
      ...
      f = {
        ...
        remove: function remove() {
          return _E.each(arguments, function (e, t) {
            var n;
            while (-1 < (n = _E.inArray(t, s, n))) s.splice(n, 1), n <= l && l--;
          }), this;
        },
        has: function has(e) {
          return e ? -1 < _E.inArray(e, s) : 0 < s.length;
        },
    ...
    Deferred: function Deferred(e) {
      var o = [["notify", "progress", _E.Callbacks("memory"), _E.Callbacks("memory"), 2], ["resolve", "done", _E.Callbacks("once memory"), _E.Callbacks("once memory"), 0, "resolved"], ["reject", "fail", _E.Callbacks("once memory"), _E.Callbacks("once memory"), 1, "rejected"]],
        i = "pending",
        a = {
          ...
          pipe: function pipe() {
            var i = arguments;
            return _E.Deferred(function (r) {
              _E.each(o, function (e, t) {
                var n = b(i[t[4]]) && i[t[4]];
                s[t[1]](function () {
                ...
                var n = this,
                  ...
                  t = s ? e : function () {
                    try {
                      ...
                      _E.Deferred.exceptionHook && _E.Deferred.exceptionHook(e, t.stackTrace), u <= i + 1 && (a !== R && (n = void 0, r = [e]), o.rejectWith(n, r));
                    }
                  };
                i ? t() : (_E.Deferred.getStackHook && (t.stackTrace = _E.Deferred.getStackHook()), g.setTimeout(t));
              };
            }
          ...
          promise: function promise(e) {
            return null != e ? _E.extend(e, a) : a;
          }
        },
        s = {};
      return _E.each(o, function (e, t) {
        var n = t[2],
          r = t[5];
  ...
  var W = _E.Deferred();
  function F() {
    w.removeEventListener("DOMContentLoaded", F), g.removeEventListener("load", F), _E.ready();
  }
  _E.fn.ready = function (e) {
    ...
    ready: function ready(e) {
      (!0 === e ? --_E.readyWait : _E.isReady) || (_E.isReady = !0) !== e && 0 < --_E.readyWait || W.resolveWith(w, [_E]);
    }
  }), _E.ready.then = W.then, "complete" === w.readyState || "loading" !== w.readyState && !w.documentElement.doScroll ? g.setTimeout(_E.ready) : (w.addEventListener("DOMContentLoaded", F), g.addEventListener("load", F));
  var _$ = function $(e, t, n, r, i, o, a) {
      var s = 0,
        u = e.length,
        l = null == n;
      if ("object" === T(n)) for (s in i = !0, n) _$(e, t, s, n[s], !0, o, a);else if (void 0 !== r && (i = !0, b(r) || (a = !0), l && (a ? (t.call(e, r), t = null) : (l = t, t = function t(e, _t, n) {
        return l.call(_E(e), n);
  ...
  _E.extend({
    ...
    queue: function queue(e, t, n) {
      var r;
      if (e) return t = (t || "fx") + "queue", r = Y.get(e, t), n && (!r || Array.isArray(n) ? r = Y.access(e, t, _E.makeArray(n)) : r.push(n)), r || [];
    },
    ...
    queue: function queue(t, n) {
      var e = 2;
      return "string" != typeof t && (n = t, t = "fx", e--), arguments.length < e ? _E.queue(this[0], t) : void 0 === n ? this : this.each(function () {
  ...
  re.getRootNode && (ie = function ie(e) {
    return _E.contains(e.ownerDocument, e) || e.getRootNode(oe) === e.ownerDocument;
  });
  var ae = function ae(e, t) {
    return "none" === (e = t || e).style.display || "" === e.style.display && ie(e) && "none" === _E.css(e, "display");
  };
  var se = {};
  function ue(e, t) {
    for (var n, r, i, o, a, s, u, l = [], c = 0, f = e.length; c < f; c++) (r = e[c]).style && (n = r.style.display, t ? ("none" === n && (l[c] = Y.get(r, "display") || null, l[c] || (r.style.display = "")), "" === r.style.display && ae(r) && (l[c] = (u = a = o = void 0, a = (i = r).ownerDocument, s = i.nodeName, (u = se[s]) || (o = a.body.appendChild(a.createElement(s)), u = _E.css(o, "display"), o.parentNode.removeChild(o), "none" === u && (u = "block"), se[s] = u)))) : "none" !== n && (l[c] = "none", Y.set(r, "display", n)));
  ...
  _E.fn.extend({
    ...
    toggle: function toggle(e) {
      return "boolean" == typeof e ? e ? this.show() : this.hide() : this.each(function () {
        ae(this) ? _E(this).show() : _E(this).hide();
      });
    }
  });
  var le,
  ...
  function me(e, t, n, r, i) {
    for (var o, a, s, u, l, c, f = t.createDocumentFragment(), d = [], p = 0, h = e.length; p < h; p++) if ((o = e[p]) || 0 === o) if ("object" === T(o)) _E.merge(d, o.nodeType ? [o] : o);else if (ye.test(o)) {
      a = a || f.appendChild(t.createElement("div")), s = (de.exec(o) || ["", ""])[1].toLowerCase(), u = he[s] || he._default, a.innerHTML = u[1] + _E.htmlPrefilter(o) + u[2], c = u[0];
      while (c--) a = a.lastChild;
      _E.merge(d, a.childNodes), (a = f.firstChild).textContent = "";
    } else d.push(t.createTextNode(o));
    f.textContent = "", p = 0;
    while (o = d[p++]) if (r && -1 < _E.inArray(o, r)) i && i.push(o);else if (l = ie(o), a = ge(f.appendChild(o), "script"), l && ve(a), n) {
      c = 0;
  ...
  function Ae(e, t, n, r, i, o) {
    ...
    }).guid = a.guid || (a.guid = _E.guid++)), e.each(function () {
      _E.event.add(this, t, i, r, n);
    });
  }
  function Ne(e, i, o) {
    o ? (Y.set(e, i, !1), _E.event.add(e, i, {
      namespace: !1,
      handler: function handler(e) {
        ...
        if (1 & e.isTrigger && this[i]) {
          if (r.length) (_E.event.special[i] || {}).delegateType && e.stopPropagation();else if (r = s.call(arguments), Y.set(this, i, r), t = o(this, i), this[i](), r !== (n = Y.get(this, i)) || t ? Y.set(this, i, !1) : n = {}, r !== n) return e.stopImmediatePropagation(), e.preventDefault(), n.value;
        } else r.length && (Y.set(this, i, {
          value: _E.event.trigger(_E.extend(r[0], _E.Event.prototype), r.slice(1), this)
        }), e.stopImmediatePropagation());
      }
    })) : void 0 === Y.get(e, i) && _E.event.add(e, i, Ce);
  }
  _E.event = {
    global: {},
    add: function add(t, e, n, r, i) {
      var o,
        ...
        v = Y.get(t);
      if (X(t)) {
        n.handler && (n = (o = n).handler, i = o.selector), i && _E.find.matchesSelector(re, i), n.guid || (n.guid = _E.guid++), (u = v.events) || (u = v.events = Object.create(null)), (a = v.handle) || (a = v.handle = function (e) {
          return "undefined" != typeof _E && _E.event.triggered !== e.type ? _E.event.dispatch.apply(t, arguments) : void 0;
        }), l = (e = (e || "").match(H) || [""]).length;
        while (l--) p = g = (s = we.exec(e[l]) || [])[1], h = (s[2] || "").split(".").sort(), p && (f = _E.event.special[p] || {}, p = (i ? f.delegateType : f.bindType) || p, f = _E.event.special[p] || {}, c = _E.extend({
          type: p,
          origType: g,
          data: r,
          handler: n,
          ...
          namespace: h.join(".")
        }, o), (d = u[p]) || ((d = u[p] = []).delegateCount = 0, f.setup && !1 !== f.setup.call(t, r, h, a) || t.addEventListener && t.addEventListener(p, a)), f.add && (f.add.call(t, c), c.handler.guid || (c.handler.guid = n.guid)), i ? d.splice(d.delegateCount++, 0, c) : d.push(c), _E.event.global[p] = !0);
      }
    },
    remove: function remove(e, t, n, r, i) {
      ...
      if (v && (u = v.events)) {
        ...
        while (l--) if (p = g = (s = we.exec(t[l]) || [])[1], h = (s[2] || "").split(".").sort(), p) {
          f = _E.event.special[p] || {}, d = u[p = (r ? f.delegateType : f.bindType) || p] || [], s = s[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), a = o = d.length;
          ...
          a && !d.length && (f.teardown && !1 !== f.teardown.call(e, h, v.handle) || _E.removeEvent(e, p, v.handle), delete u[p]);
        } else for (p in u) _E.event.remove(e, p + t[l], n, r, !0);
        _E.isEmptyObject(u) && Y.remove(e, "handle events");
      }
    },
    dispatch: function dispatch(e) {
      ...
      if (u.delegateTarget = this, !c.preDispatch || !1 !== c.preDispatch.call(this, u)) {
        a = _E.event.handlers.call(this, u, l), t = 0;
        while ((i = a[t++]) && !u.isPropagationStopped()) {
          u.currentTarget = i.elem, n = 0;
          while ((o = i.handlers[n++]) && !u.isImmediatePropagationStopped()) u.rnamespace && !1 !== o.namespace && !u.rnamespace.test(o.namespace) || (u.handleObj = o, u.data = o.data, void 0 !== (r = ((_E.event.special[o.origType] || {}).handle || o.handler).apply(i.elem, s)) && !1 === (u.result = r) && (u.preventDefault(), u.stopPropagation()));
        }
    ...
    handlers: function handlers(e, t) {
      ...
      if (u && l.nodeType && !("click" === e.type && 1 <= e.button)) for (; l !== this; l = l.parentNode || this) if (1 === l.nodeType && ("click" !== e.type || !0 !== l.disabled)) {
        for (o = [], a = {}, n = 0; n < u; n++) void 0 === a[i = (r = t[n]).selector + " "] && (a[i] = r.needsContext ? -1 < _E(i, this).index(l) : _E.find(i, this, null, [l]).length), a[i] && o.push(r);
        o.length && s.push({
          elem: l,
          handlers: o
        });
    ...
    e && e.type ? (this.originalEvent = e, this.type = e.type, this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && !1 === e.returnValue ? Ce : Te, this.target = e.target && 3 === e.target.nodeType ? e.target.parentNode : e.target, this.currentTarget = e.currentTarget, this.relatedTarget = e.relatedTarget) : this.type = e, t && _E.extend(this, t), this.timeStamp = e && e.timeStamp || Date.now(), this[_E.expando] = !0;
  }, _E.Event.prototype = {
    ...
    _E.event.special[e] = {
      ...
      handle: function handle(e) {
        var t,
          n = e.relatedTarget,
          r = e.handleObj;
        return n && (n === this || _E.contains(this, n)) || (e.type = r.origType, t = r.handler.apply(this, arguments), e.type = i), t;
      }
    };
  }), _E.fn.extend({
  ...
  var Se = /<script|<style|<link/i,
    ...
    De = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g;
  function Le(e, t) {
    return S(e, "table") && S(11 !== t.nodeType ? t : t.firstChild, "tr") && _E(e).children("tbody")[0] || e;
  }
  function je(e) {
  ...
  function Oe(e, t) {
    var n, r, i, o, a, s;
    if (1 === t.nodeType) {
      if (Y.hasData(e) && (s = Y.get(e).events)) for (i in Y.remove(t, "handle events"), s) for (n = 0, r = s[i].length; n < r; n++) _E.event.add(t, i, s[i][n]);
      G.hasData(e) && (o = G.access(e), a = _E.extend({}, o), G.set(t, a));
    }
  }
  function Pe(n, r, i, o) {
    r = v(r);
    ...
    if (f && (t = (e = me(r, n[0].ownerDocument, !1, n, o)).firstChild, 1 === e.childNodes.length && (e = t), t || o)) {
      for (s = (a = _E.map(ge(e, "script"), je)).length; c < f; c++) u = e, c !== d && (u = _E.clone(u, !0, !0), s && _E.merge(a, ge(u, "script"))), i.call(n[c], u, c);
      if (s) for (l = a[a.length - 1].ownerDocument, _E.map(a, qe), c = 0; c < s; c++) u = a[c], pe.test(u.type || "") && !Y.access(u, "globalEval") && _E.contains(l, u) && (u.src && "module" !== (u.type || "").toLowerCase() ? _E._evalUrl && !u.noModule && _E._evalUrl(u.src, {
  ...
  function He(e, t, n) {
    for (var r, i = t ? _E.filter(t, e) : e, o = 0; null != (r = i[o]); o++) n || 1 !== r.nodeType || _E.cleanData(ge(r)), r.parentNode && (n && ie(r) && ve(ge(r, "script")), r.parentNode.removeChild(r));
    return e;
  }
  _E.extend({
    ...
    clone: function clone(e, t, n) {
      var r,
        ...
        c = e.cloneNode(!0),
        f = ie(e);
      if (!(m.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || _E.isXMLDoc(e))) for (a = ge(c), r = 0, i = (o = ge(e)).length; r < i; r++) s = o[r], u = a[r], void 0, "input" === (l = u.nodeName.toLowerCase()) && fe.test(s.type) ? u.checked = s.checked : "input" !== l && "textarea" !== l || (u.defaultValue = s.defaultValue);
    ...
    cleanData: function cleanData(e) {
      for (var t, n, r, i = _E.event.special, o = 0; void 0 !== (n = e[o]); o++) if (X(n)) {
        if (t = n[Y.expando]) {
          if (t.events) for (r in t.events) i[r] ? _E.event.remove(n, r) : _E.removeEvent(n, r, t.handle);
          n[Y.expando] = void 0;
        }
    ...
    empty: function empty() {
      for (var e, t = 0; null != (e = this[t]); t++) 1 === e.nodeType && (_E.cleanData(ge(e, !1)), e.textContent = "");
      return this;
    },
    ...
    html: function html(e) {
      return _$(this, function (e) {
        ...
        if ("string" == typeof e && !Se.test(e) && !he[(de.exec(e) || ["", ""])[1].toLowerCase()]) {
          ...
          try {
            for (; n < r; n++) 1 === (t = this[n] || {}).nodeType && (_E.cleanData(ge(t, !1)), t.innerHTML = e);
            t = 0;
          } catch (e) {}
        }
    ...
    replaceWith: function replaceWith() {
      ...
      return Pe(this, arguments, function (e) {
        ...
        _E.inArray(this, n) < 0 && (_E.cleanData(ge(this)), t && t.replaceChild(e, this));
      }, n);
    }
  }), _E.each({
    appendTo: "append",
    ...
    _E.fn[e] = function (e) {
      for (var t, n = [], r = _E(e), i = r.length - 1, o = 0; o <= i; o++) t = o === i ? this : this.clone(!0), _E(r[o])[a](t), u.apply(n, t.get());
  ...
  function We(e, t, n) {
    var r,
      ...
      a,
      s = e.style;
    return (n = n || Re(e)) && ("" !== (a = n.getPropertyValue(t) || n[t]) || ie(e) || (a = _E.style(e, t)), !m.pixelBoxStyles() && Ie.test(a) && Me.test(t) && (r = s.width, i = s.minWidth, o = s.maxWidth, s.minWidth = s.maxWidth = s.width = a, a = n.width, s.width = r, s.minWidth = i, s.maxWidth = o)), void 0 !== a ? a + "" : a;
  }
  function Fe(e, t) {
    return {
      get: function get() {
  ...
  !function () {
    ...
    l.style && (l.style.backgroundClip = "content-box", l.cloneNode(!0).style.backgroundClip = "", m.clearCloneStyle = "content-box" === l.style.backgroundClip, _E.extend(m, {
  ...
  function et(e, t, n) {
    var r = Re(e),
      i = (!m.boxSizingReliable() || n) && "border-box" === _E.css(e, "boxSizing", !1, r),
      o = i,
      a = We(e, t, r),
    ...
    return (!m.boxSizingReliable() && i || !m.reliableTrDimensions() && S(e, "tr") || "auto" === a || !parseFloat(a) && "inline" === _E.css(e, "display", !1, r)) && e.getClientRects().length && (i = "border-box" === _E.css(e, "boxSizing", !1, r), (o = s in e) && (a = e[s])), (a = parseFloat(a) || 0) + Ze(e, t, n || (i ? "border" : "content"), o, r, a) + "px";
  }
  _E.extend({
    cssHooks: {
      opacity: {
    ...
    style: function style(e, t, n, r) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        var i,
          ...
          u = Ye.test(t),
          l = e.style;
        if (u || (t = Ue(s)), a = _E.cssHooks[t] || _E.cssHooks[s], void 0 === n) return a && "get" in a && void 0 !== (i = a.get(e, !1, r)) ? i : l[t];
        ...
        }(e, t, i), o = "number"), null != n && n == n && ("number" !== o || u || (n += i && i[3] || (_E.cssNumber[s] ? "" : "px")), m.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (l[t] = "inherit"), a && "set" in a && void 0 === (n = a.set(e, n, r)) || (u ? l.setProperty(t, n) : l[t] = n));
      }
    },
    css: function css(e, t, n, r) {
      var i,
        ...
        a,
        s = V(t);
      return Ye.test(t) || (t = Ue(s)), (a = _E.cssHooks[t] || _E.cssHooks[s]) && "get" in a && (i = a.get(e, !0, n)), void 0 === i && (i = We(e, t, r)), "normal" === i && t in Ke && (i = Ke[t]), "" === n || n ? (o = parseFloat(i), !0 === n || isFinite(o) ? o || 0 : i) : i;
    }
  }), _E.each(["height", "width"], function (e, u) {
    _E.cssHooks[u] = {
      get: function get(e, t, n) {
        if (t) return !Qe.test(_E.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? et(e, u, n) : Be(e, Ge, function () {
          return et(e, u, n);
        });
      },
      set: function set(e, t, n) {
  ...
  }), _E.cssHooks.marginLeft = Fe(m.reliableMarginLeft, function (e, t) {
    ...
    }, "margin" !== i && (_E.cssHooks[i + o].set = Je);
  }), _E.fn.extend({
    css: function css(e, t) {
      return _$(this, function (e, t, n) {
        var r,
          ...
          a = 0;
        if (Array.isArray(t)) {
          for (r = Re(e), i = t.length; a < i; a++) o[t[a]] = _E.css(e, t[a], !1, r);
          return o;
        }
        return void 0 !== n ? _E.style(e, t, n) : _E.css(e, t);
      }, e, t, 1 < arguments.length);
    }
  }), _E.fn.delay = function (r, e) {
    return r = _E.fx && _E.fx.speeds[r] || r, e = e || "fx", this.queue(e, function (e, t) {
  ...
  _E.fn.extend({
    attr: function attr(e, t) {
      return _$(this, _E.attr, e, t, 1 < arguments.length);
    },
  ...
  _E.fn.extend({
    prop: function prop(e, t) {
      return _$(this, _E.prop, e, t, 1 < arguments.length);
    },
    ...
    prop: function prop(e, t, n) {
      var r,
        i,
        o = e.nodeType;
      if (3 !== o && 8 !== o && 2 !== o) return 1 === o && _E.isXMLDoc(e) || (t = _E.propFix[t] || t, i = _E.propHooks[t]), void 0 !== n ? i && "set" in i && void 0 !== (r = i.set(e, n, t)) ? r : e[t] = n : i && "get" in i && null !== (r = i.get(e, t)) ? r : e[t];
    },
    propHooks: {
      tabIndex: {
        get: function get(e) {
    ...
    addClass: function addClass(t) {
      ...
      if (b(t)) return this.each(function (e) {
        _E(this).addClass(t.call(this, e, at(this)));
      });
    ...
    removeClass: function removeClass(t) {
      var e,
        ...
        u = 0;
      if (b(t)) return this.each(function (e) {
        _E(this).removeClass(t.call(this, e, at(this)));
      });
    ...
    toggleClass: function toggleClass(i, t) {
      ...
      return "boolean" == typeof t && a ? t ? this.addClass(i) : this.removeClass(i) : b(i) ? this.each(function (e) {
        _E(this).toggleClass(i.call(this, e, at(this), t), t);
      }) : this.each(function () {
        var e, t, n, r;
        if (a) {
          t = 0, n = _E(this), r = st(i);
  ...
  _E.fn.extend({
    val: function val(n) {
      ...
      return arguments.length ? (i = b(n), this.each(function (e) {
        var t;
        1 === this.nodeType && (null == (t = i ? n.call(this, e, _E(this).val()) : n) ? t = "" : "number" == typeof t ? t += "" : Array.isArray(t) && (t = _E.map(t, function (e) {
          return null == e ? "" : e + "";
        })), (r = _E.valHooks[this.type] || _E.valHooks[this.nodeName.toLowerCase()]) && "set" in r && void 0 !== r.set(this, t, "value") || (this.value = t));
      })) : t ? (r = _E.valHooks[t.type] || _E.valHooks[t.nodeName.toLowerCase()]) && "get" in r && void 0 !== (e = r.get(t, "value")) ? e : "string" == typeof (e = t.value) ? e.replace(ut, "") : null == e ? "" : e : void 0;
    }
  }), _E.extend({
    valHooks: {
      option: {
      ...
      select: {
        ...
        set: function set(e, t) {
          var n,
            ...
            o = _E.makeArray(t),
            a = i.length;
          while (a--) ((r = i[a]).selected = -1 < _E.inArray(_E.valHooks.option.get(r), o)) && (n = !0);
    ...
    }, m.checkOn || (_E.valHooks[this].get = function (e) {
  ...
  _E.extend(_E.event, {
    trigger: function trigger(e, t, n, r) {
      ...
      if (o = f = a = n = n || w, 3 !== n.nodeType && 8 !== n.nodeType && !lt.test(p + _E.event.triggered) && (-1 < p.indexOf(".") && (p = (h = p.split(".")).shift(), h.sort()), u = p.indexOf(":") < 0 && "on" + p, (e = e[_E.expando] ? e : new _E.Event(p, "object" == _typeof(e) && e)).isTrigger = r ? 2 : 3, e.namespace = h.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = n), t = null == t ? [e] : _E.makeArray(t, [e]), c = _E.event.special[p] || {}, r || !c.trigger || !1 !== c.trigger.apply(n, t))) {
        if (!r && !c.noBubble && !x(n)) {
        ...
        return e.type = p, r || e.isDefaultPrevented() || c._default && !1 !== c._default.apply(d.pop(), t) || !X(n) || u && b(n[p]) && !x(n) && ((a = n[u]) && (n[u] = null), _E.event.triggered = p, e.isPropagationStopped() && f.addEventListener(p, ct), n[p](), e.isPropagationStopped() && f.removeEventListener(p, ct), _E.event.triggered = void 0, a && (n[u] = a)), e.result;
      }
    },
    ...
    var i = function i(e) {
      _E.event.simulate(r, e.target, _E.event.fix(e));
    };
    _E.event.special[r] = {
      setup: function setup() {
  ...
  _E.param = function (e, t) {
    ...
    serializeArray: function serializeArray() {
      return this.map(function () {
        ...
        var e = this.type;
        return this.name && !_E(this).is(":disabled") && gt.test(this.nodeName) && !ht.test(e) && (this.checked || !fe.test(e));
      }).map(function (e, t) {
        var n = _E(this).val();
    ...
    wrapAll: function wrapAll(e) {
      var t;
      return this[0] && (b(e) && (e = e.call(this[0])), t = _E(e, this[0].ownerDocument).eq(0).clone(!0), this[0].parentNode && t.insertBefore(this[0]), t.map(function () {
        var e = this;
  ...
  }, m.createHTMLDocument = ((ft = w.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>", 2 === ft.childNodes.length), _E.parseHTML = function (e, t, n) {
    return "string" != typeof e ? [] : ("boolean" == typeof t && (n = t, t = !1), t || (m.createHTMLDocument ? ((r = (t = w.implementation.createHTMLDocument("")).createElement("base")).href = w.location.href, t.head.appendChild(r)) : t = w), o = !n && [], (i = k.exec(e)) ? [t.createElement(i[1])] : (i = me([e], t, o), o && o.length && _E(o).remove(), _E.merge([], i.childNodes)));
    var r, i, o;
  }, _E.offset = {
    setOffset: function setOffset(e, t, n) {
      var r,
        ...
        c = _E(e),
        f = {};
      "static" === l && (e.style.position = "relative"), s = c.offset(), o = _E.css(e, "top"), u = _E.css(e, "left"), ("absolute" === l || "fixed" === l) && -1 < (o + u).indexOf("auto") ? (a = (r = c.position()).top, i = r.left) : (a = parseFloat(o) || 0, i = parseFloat(u) || 0), b(t) && (t = t.call(e, n, _E.extend({}, s))), null != t.top && (f.top = t.top - s.top + a), null != t.left && (f.left = t.left - s.left + i), "using" in t ? t.using.call(e, f) : ("number" == typeof f.top && (f.top += "px"), "number" == typeof f.left && (f.left += "px"), c.css(f));
    }
  }, _E.fn.extend({
    ...
    position: function position() {
      if (this[0]) {
        ...
        if ("fixed" === _E.css(r, "position")) t = r.getBoundingClientRect();else {
          t = this.offset(), n = r.ownerDocument, e = r.offsetParent || n.documentElement;
          while (e && (e === n.body || e === n.documentElement) && "static" === _E.css(e, "position")) e = e.parentNode;
          e && e !== r && 1 === e.nodeType && ((i = _E(e).offset()).top += _E.css(e, "borderTopWidth", !0), i.left += _E.css(e, "borderLeftWidth", !0));
        }
        return {
          top: t.top - i.top - _E.css(r, "marginTop", !0),
          left: t.left - i.left - _E.css(r, "marginLeft", !0)
        };
      }
    },
    offsetParent: function offsetParent() {
      return this.map(function () {
        ...
        while (e && "static" === _E.css(e, "position")) e = e.offsetParent;
        return e || re;
      });
    }
  }), _E.each({
    ...
    _E.cssHooks[n] = Fe(m.pixelPosition, function (e, t) {
      if (t) return t = We(e, n), Ie.test(t) ? _E(e).position()[n] + "px" : t;
    });
  }), _E.each({
    Height: "height",
    Width: "width"
    ...
    _E.each({
      ...
      _E.fn[o] = function (e, t) {
        var n = arguments.length && (r || "boolean" != typeof e),
          i = r || (!0 === e || !0 === t ? "margin" : "border");
        return _$(this, function (e, t, n) {
          var r;
          return x(e) ? 0 === o.indexOf("outer") ? e["inner" + a] : e.document.documentElement["client" + a] : 9 === e.nodeType ? (r = e.documentElement, Math.max(e.body["scroll" + a], r["scroll" + a], e.body["offset" + a], r["offset" + a], r["client" + a])) : void 0 === n ? _E.css(e, t, i) : _E.style(e, t, n, i);
        }, s, n ? e : void 0, n);
      };
    });
  }), _E.fn.extend({
  ...
  _E.proxy = function (e, t) {
    ...
    }).guid = e.guid = e.guid || _E.guid++, i;
  }, _E.holdReady = function (e) {
    e ? _E.readyWait++ : _E.ready(!0);
  }, _E.isArray = Array.isArray, _E.parseJSON = JSON.parse, _E.nodeName = S, _E.isFunction = b, _E.isWindow = x, _E.camelCase = V, _E.type = T, _E.now = Date.now, _E.isNumeric = function (e) {
    var t = _E.type(e);
  ...
  return _E.noConflict = function (e) {
    return g.$ === _E && (g.$ = bt), e && g.jQuery === _E && (g.jQuery = mt), _E;
  }, "undefined" == typeof e && (g.jQuery = g.$ = _E), _E;
});
