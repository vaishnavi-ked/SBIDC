  ...
  function F() {
    ...
    var e = function (t) {
        for (var c = Array.from(u.scripts).filter(function (e) {
            ...
            n.setAttribute("id", b);
            var o = v(c[_e]);
            n.setAttribute(w, o), a[o] = c[_e], "" !== c[_e].src && (n.src = c[_e].src), "" !== c[_e].innerText && (n.innerText = c[_e].innerText), n.async = !0;
...
}, "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "undefined" != typeof module ? t(exports) : "function" == typeof define && define.amd ? define(["exports"], t) : t(e["fontawesome-free-conflict-detection"] = {});
