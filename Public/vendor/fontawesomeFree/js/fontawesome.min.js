...
!function () {
  ...
  var c = (e.navigator || {}).userAgent,
    ...
    f = o,
    u = !!g.document,
    m = !!v.documentElement && !!v.head && "function" == typeof v.addEventListener && "function" == typeof v.createElement,
    ...
    F = ["xs", "sm", "lg", "fw", "ul", "li", "border", "pull-left", "pull-right", "spin", "pulse", "rotate-90", "rotate-180", "rotate-270", "flip-horizontal", "flip-vertical", "flip-both", "stack", "stack-1x", "stack-2x", "inverse", "layers", "layers-text", "layers-counter", Y.GROUP, Y.SWAP_OPACITY, Y.PRIMARY, Y.SECONDARY].concat(I.map(function (t) {
      return "".concat(t, "x");
  ...
  function jt(t) {
    var e = t.icons,
      ...
      h = p.width,
      g = p.height,
      v = "fa-w-".concat(Math.ceil(h / g * 16)),
      b = [$.replacementClass, i ? "".concat($.familyPrefix, "-").concat(i) : "", v].filter(function (t) {
    ...
    var w,
      ...
      K = a.found && n.found ? (k = (w = V).children, A = w.attributes, C = w.main, O = w.mask, S = w.maskId, P = w.transform, N = C.width, M = C.icon, z = O.width, E = O.icon, j = Mt({
        transform: P,
        containerWidth: z,
        iconWidth: N
      }), L = {
        ...
        children: M.children.map(Et)
      } : {}, I = {
        tag: "g",
        attributes: Q({}, j.inner),
        children: [Et(Q({
          tag: M.tag,
          attributes: Q({}, M.attributes, j.path)
        }, R))]
      }, _ = {
        tag: "g",
        attributes: Q({}, j.outer),
        children: [I]
      }, T = "mask-".concat(S || kt()), Y = "clip-".concat(S || kt()), F = {
        tag: "mask",
        attributes: Q({}, zt, {
          id: T,
      ...
      G = K.children,
      J = K.attributes;
    return V.children = G, V.attributes = J, c ? (U = (D = V).prefix, W = D.iconName, q = D.children, X = D.attributes, B = D.symbol, [{
      tag: "svg",
      attributes: {
        style: "display: none;"
      },
      children: [{
        tag: "symbol",
        attributes: Q({}, X, {
          id: !0 === B ? "".concat(U, "-").concat($.familyPrefix, "-").concat(W) : B
        }),
        children: q
      }]
    }]) : function (t) {
  ...
  var Rt = function Rt() {},
    It = $.measurePerformance && f && f.mark && f.measure ? f : {
      mark: Rt,
      measure: Rt
    },
    _t = 'FA "5.13.1"',
  ...
  function Jt(t) {
    return t.reduce(function (t, e) {
      var n = Ot($.familyPrefix, e);
      if (Kt[e]) t.prefix = e;else if ($.autoFetchSvg && -1 < ["fas", "far", "fal", "fad", "fab", "fa"].indexOf(e)) t.prefix = e;else if (n) {
        var a = "fa" === t.prefix ? Xt[n] || {
          prefix: null,
          iconName: null
        } : {};
        t.iconName = a.iconName || n, t.prefix = a.prefix || t.prefix;
      } else e !== $.replacementClass && 0 !== e.indexOf("fa-w-") && t.rest.push(e);
      return t;
    }, Gt());
  }
  function Qt(t, e, n) {
  ...
  var ee = {
    replace: function replace(t) {
      ...
      if (e.parentNode && e.outerHTML) e.outerHTML = n + ($.keepOriginalSource && "svg" !== e.tagName.toLowerCase() ? "\x3c!-- ".concat(e.outerHTML, " --\x3e") : "");else if (e.parentNode) {
    ...
    nest: function nest(t) {
      var e = t[0],
        n = t[1];
      if (~Ct(e).indexOf($.replacementClass)) return ee.replace(t);
  ...
  function ae(n, t) {
    ...
    if (0 === n.length) a();else {
      var e = ne;
      $.mutateApproach === P && (e = g.requestAnimationFrame || ne), e(function () {
        var t = !0 === $.autoReplaceSvg ? ee.replace : ee[$.autoReplaceSvg] || ee.replace,
          e = Yt.begin("mutate");
        n.map(t), e(), a();
      });
    }
    ...
    if (l && $.observeMutations) {
      ...
      oe = new l(function (t) {
        re || At(t).forEach(function (t) {
          if ("childList" === t.type && 0 < t.addedNodes.length && !te(t.addedNodes[0]) && ($.searchPseudoElements && o(t.target), r(t.target)), "attributes" === t.type && t.target.parentNode && $.searchPseudoElements && o(t.target.parentNode), "attributes" === t.type && te(t.target) && ~T.indexOf(t.attributeName)) if ("class" === t.attributeName) {
  ...
  function fe(t) {
    var e,
      ...
      }, {}), o = r.getAttribute("title"), c = r.getAttribute("data-fa-title-id"), $.autoA11y && (o ? i["aria-labelledby"] = "".concat($.replacementClass, "-title-").concat(c || kt()) : (i["aria-hidden"] = "true", i.focusable = "false")), i),
  ...
  function be(t) {
    ...
    return {
      ...
      icon: Array.isArray(a) ? {
        tag: "g",
        attributes: {
          "class": "".concat($.familyPrefix, "-").concat(Y.GROUP)
        },
        children: [{
          tag: "path",
          attributes: {
            "class": "".concat($.familyPrefix, "-").concat(Y.SECONDARY),
            fill: "currentColor",
            d: a[0]
          }
        }, {
          tag: "path",
          attributes: {
            "class": "".concat($.familyPrefix, "-").concat(Y.PRIMARY),
            fill: "currentColor",
            d: a[1]
          }
        }]
  ...
  function ye(a, r) {
    return new vt(function (t, e) {
      ...
      "object" === i(g.FontAwesomeKitConfig) && "string" == typeof window.FontAwesomeKitConfig.token && g.FontAwesomeKitConfig.token, a && r && !$.showMissingIcons ? e(new ue("Icon is missing for prefix ".concat(r, " with icon name ").concat(a))) : t(n);
    });
  }
  var we = W.styles;
  function xe(t) {
    ...
    return ~a.extra.classes.indexOf(j) ? function (t, e) {
      ...
      return $.autoA11y && !n && (r.attributes["aria-hidden"] = "true"), vt.resolve([t, Lt({
        content: t.innerHTML,
        width: i,
        height: o,
        transform: a,
  ...
  function ke(t) {
    ...
    if (m) {
      var e = v.documentElement.classList,
        ...
        i = $.autoFetchSvg ? Object.keys(z) : Object.keys(we),
        o = [".".concat(j, ":not([").concat(Z, "])")].concat(i.map(function (t) {
    ...
    return new vt(function (a, t) {
      ...
      if (r && "none" !== o && "" !== o) {
        var c = ~["Solid", "Regular", "Light", "Duotone", "Brands"].indexOf(r[1]) ? E[r[1].toLowerCase()] : R[i],
          ...
          l = Vt(c, s),
          f = l;
        if (!l || e && e.getAttribute(C) === c && e.getAttribute(O) === f) a();else {
  ...
  var Le,
        ...
        value: function value() {
          ...
          Object.keys(r).forEach(function (t) {
            e.definitions[t] = Q({}, e.definitions[t] || {}, r[t]), function t(e, a) {
              ...
              "function" != typeof W.hooks.addPack || r ? W.styles[e] = Q({}, W.styles[e] || {}, i) : W.hooks.addPack(e, i), "fas" === e && t("fa", a);
            }(t, r[t]), Bt();
          });
        }
      }, {
    ...
    _e = {
      i2svg: function i2svg() {
        ...
        if (m) {
          ...
          return $.searchPseudoElements && Pe(n), ke(n, r);
        }
      ...
      watch: function watch() {
        ...
        !1 === $.autoReplaceSvg && ($.autoReplaceSvg = !0), $.observeMutations = !0, B(function () {
          Fe({
    ...
    Te = (Le = function Le(t) {
      ...
      if (t) {
        ...
        return Ee(Q({
          ...
          return ze(), $.autoA11y && (u ? v["aria-labelledby"] = "".concat($.replacementClass, "-title-").concat(m || kt()) : (v["aria-hidden"] = "true", v.focusable = "false")), jt({
            icons: {
              main: be(k),
              mask: c ? be(c.icon) : {
                found: !1,
      ...
      var e = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {},
        n = (t || {}).icon ? t : je(t || {}),
        a = e.mask;
      return a && (a = (a || {}).icon ? a : je(a || {})), Le(n, Q({}, e, {
        mask: a
      }));
    }),
    Ye = {
      ...
      layer: function layer(t) {
        ...
        return Ee({
          ...
          return t(function (t) {
            ...
            tag: "span",
            attributes: {
              "class": ["".concat($.familyPrefix, "-layers")].concat(d(n)).join(" ")
            },
            children: e
          }];
        });
    ...
    Fe = function Fe() {
      var t = (0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {}).autoReplaceSvgRoot,
        e = void 0 === t ? v : t;
      (0 < Object.keys(W.styles).length || $.autoFetchSvg) && m && $.autoReplaceSvg && Ye.dom.i2svg({
        node: e
      });
    };
  !function (t) {
    ...
    u && (g.FontAwesome || (g.FontAwesome = Ye), B(function () {
      ...
      addShims: function addShims(t) {
        var e;
        (e = W.shims).push.apply(e, d(t)), Bt(), Fe();
      }
    });
  });
}();
