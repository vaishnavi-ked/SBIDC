 ...
 */
!function (t, e) {
  if ("object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "object" == (typeof module === "undefined" ? "undefined" : _typeof(module))) module.exports = e(function () {
    try {
      return require("jspdf");
    } catch (t) {}
  }());else if ("function" == typeof define && define.amd) define(["jspdf"], e);else {
    var n = "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? e(function () {
      try {
        return require("jspdf");
      } catch (t) {}
    }()) : e(t.jspdf);
...
}("undefined" != typeof globalThis ? globalThis : void 0 !== this ? this : "undefined" != typeof window ? window : "undefined" != typeof self ? self : global, function (t) {
  return function () {
    "use strict";
    ...
    var e = {
        ...
        200: function _(t, e) {
          ...
          Object.defineProperty(e, "__esModule", {
            ...
            return "object" == _typeof(t) ? ("number" == typeof t.vertical && (t.top = t.vertical, t.bottom = t.vertical), "number" == typeof t.horizontal && (t.right = t.horizontal, t.left = t.horizontal), {
        ...
        913: function _(t, e) {
          var _n2,
            o = this && this.__extends || (_n2 = function n(t, e) {
              ...
              _n2(t, e), t.prototype = null === e ? Object.create(e) : (o.prototype = e.prototype, new o());
            });
          Object.defineProperty(e, "__esModule", {
            value: !0
        ...
        259: function _(t, e, n) {
          ...
          e.parseCss = function (t, e, n, i, l) {
            ...
            var g = ["left", "right", "center", "justify"];
            -1 !== g.indexOf(i.textAlign) && (a.halign = i.textAlign), -1 !== (g = ["middle", "bottom", "top"]).indexOf(i.verticalAlign) && (a.valign = i.verticalAlign);
        ...
        148: function _(t, e, n) {
          ...
          function i(t, e, n, i, a, s) {
            ...
            var g = n.getComputedStyle(i);
            if (u.length > 0 && (a || "none" !== g.display)) return u;
          }
          function l(t) {
            var e = t.cloneNode(!0);
          ...
          e.parseHtml = function (t, e, n, o, r) {
            ...
            for (var g = 0; g < s.rows.length; g++) {
              var p = s.rows[g],
                y = null === (a = null === (l = null == p ? void 0 : p.parentElement) || void 0 === l ? void 0 : l.tagName) || void 0 === a ? void 0 : a.toLowerCase(),
                v = i(u, d, n, p, o, r);
        ...
        587: function _(t, e, n) {
          ...
          function s(t, e, n) {
            ...
            return Object.keys(o).filter(function (t) {
              ...
              var e,
                n = 1;
              "object" != _typeof(e = Array.isArray(o) ? o[parseInt(t)] : o[t]) || Array.isArray(e) || (n = (null == e ? void 0 : e.colSpan) || 1);
              for (var i = 0; i < n; i++) {
                var l = {
                  dataKey: Array.isArray(o) ? r.length : t + (i > 0 ? "_".concat(i) : "")
                };
                r.push(l);
              }
            }), r;
          ...
          e.parseInput = function (t, e) {
            ...
            var f = function (t, e, n) {
              ...
              p = function (t, e) {
                ...
                g = !0 === e.showFoot ? "everyPage" : !1 === e.showFoot ? "never" : null !== (o = e.showFoot) && void 0 !== o ? o : "everyPage";
                p = !0 === e.showHead ? "everyPage" : !1 === e.showHead ? "never" : null !== (r = e.showHead) && void 0 !== r ? r : "everyPage";
        ...
        291: function _(t, e) {
          ...
          Object.defineProperty(e, "__esModule", {
            ...
            for (var i = function i(e) {
                e && "object" != _typeof(e) && console.error("The options parameter should be of type object, is: " + _typeof(e)), void 0 !== e.extendWidth && (e.tableWidth = e.extendWidth ? "auto" : "wrap", console.error("Use of deprecated option: extendWidth, use tableWidth instead.")), void 0 !== e.margins && (void 0 === e.margin && (e.margin = e.margins), console.error("Use of deprecated option: margins, use margin instead.")), e.startY && "number" != typeof e.startY && (console.error("Invalid value for startY option", e.startY), delete e.startY), !e.didDrawPage && (e.afterPageContent || e.beforePageContent || e.afterPageAdd) && (console.error("The afterPageContent, beforePageContent and afterPageAdd hooks are deprecated. Use didDrawPage instead"), e.didDrawPage = function (n) {
                  ...
                  e[t] && console.error('The "'.concat(t, '" hook has changed in version 3.0, check the changelog for how to migrate.'));
                  ...
                  var n = t[0],
                    o = t[1];
                  e[o] && (console.error("Use of deprecated option ".concat(o, ". Use ").concat(n, " instead")), e[n] = e[o]);
        ...
        287: function _(t, e, n) {
          ...
          var s = function () {
            function t(t, e, n) {
              ...
              var i = t;
              null == t || "object" != _typeof(t) || Array.isArray(t) ? (this.rowSpan = 1, this.colSpan = 1) : (this.rowSpan = t.rowSpan || 1, this.colSpan = t.colSpan || 1, i = null !== (r = null !== (o = t.content) && void 0 !== o ? o : t.title) && void 0 !== r ? r : t, t._element && (this.raw = t._element));
              var l = null != i ? "" + i : "";
              this.text = l.split(/\r\n|\r|\n/g);
            }
        ...
        858: function _(t, e, n) {
          ...
          function s(t, e, n, o, i, l) {
            ...
            return e.map(function (e, s) {
              for (var u = 0, h = {}, c = 0, f = 0, g = 0, p = n; g < p.length; g++) {
                var y = p[g];
                if (null == a[y.index] || 0 === a[y.index].left) {
                  if (0 === f) {
                    var v = void 0,
                      m = {};
                    "object" != _typeof(v = Array.isArray(e) ? e[y.index - c - u] : e[y.dataKey]) || Array.isArray(v) || (m = (null == v ? void 0 : v.styles) || {});
          ...
          function u(t, e) {
            ...
            return t.forEach(function (t) {
              if (null != t.raw) {
                var o = function (t, e) {
                  if ("head" === t) {
                    if ("object" == _typeof(e)) return e.header || e.title || null;
                    if ("string" == typeof e || "number" == typeof e) return e;
                  } else if ("foot" === t && "object" == _typeof(e)) return e.footer;
                  return null;
                }(e, t.raw);
          ...
          function d(t, e, n, o, r, i, s) {
            ...
            var h = (0, a.assign)({}, d.table, d[t], r.styles, u),
              ...
              f = "body" === t ? c : {},
              g = "body" === t && n % 2 == 0 ? (0, a.assign)({}, d.alternateRow, r.alternateRowStyles) : {},
              p = (0, l.defaultStyles)(i),
              y = (0, a.assign)({}, p, h, g, f);
                ...
                var n = t.content,
                  o = function (t) {
                    return t.map(function (t, e) {
                      var n, o, i;
                      return i = "object" == _typeof(t) && null !== (o = null !== (n = t.dataKey) && void 0 !== n ? n : t.key) && void 0 !== o ? o : e, new r.Column(i, t, e);
                    });
                  }(n.columns);
                if (0 === n.head.length) {
        ...
        49: function _(t, e, n) {
          ...
          function h(t, e, n, o, r, l, s) {
            ...
            if (n.canEntireRowFit(u, s)) c(t, e, n, l, s);else if (function (t, e, n, o) {
              ...
              var a = e.getMinimumRowHeight(o.columns, t),
                s = a < n;
              if (a > l) return console.error("Will not be able to print row ".concat(e.index, " correctly since it's minimum height is larger than page height")), !0;
              if (!s) return !1;
              var u = e.hasRowSpan(o.columns);
              return e.getMaxCellHeight(o.columns) > l ? (u && console.error("The content of row ".concat(e.index, " will not be drawn correctly since drawing rows with a height larger than the page height and has cells with rowspans is not supported.")), !0) : !u && "avoid" !== o.settings.rowPageBreak;
            }(t, n, u, e)) {
              var f = function (t, e, n, o) {
                ...
                for (var l = 0, s = 0, u = n.columns; s < u.length; s++) {
                  ...
                  if (m = t.cells[h.index]) {
                    ...
                    var g = o.scaleFactor();
                    m.contentHeight = m.getContentHeight(g), m.contentHeight >= e && (m.contentHeight = e, c.styles.minCellHeight -= e), m.contentHeight > t.height && (t.height = m.contentHeight), c.contentHeight = c.getContentHeight(g), c.contentHeight > l && (l = c.contentHeight), r[h.index] = c;
                  }
                }
                var p = new i.Row(t.raw, -1, t.section, r, !0);
                p.height = l;
                for (var y = 0, v = n.columns; y < v.length; y++) {
                  var m;
                  h = v[y], (c = p.cells[h.index]) && (c.height = p.height), (m = t.cells[h.index]) && (m.height = t.height);
                }
                return p;
              }(n, u, e, t);
              c(t, e, n, l, s), g(t, e, r, l, s), h(t, e, f, o, r, l, s);
            } else g(t, e, r, l, s), h(t, e, n, o, r, l, s);
          }
          ...
          function f(t, e, n) {
            ...
            } else if ("object" == _typeof(o.lineWidth)) {
          ...
          function g(t, e, n, o, i) {
            ...
            (0, r.addTableBorder)(t, e, n, o), p(t), e.pageNumber++, e.pageCount++, o.x = l.left, o.y = l.top, n.y = l.top, "everyPage" === e.settings.showHead && e.head.forEach(function (n) {
              return c(t, e, n, o, i);
            });
          }
          function p(t) {
          ...
          e.drawTable = function (t, e) {
            ...
            ("always" === n.pageBreak || null != n.startY && f > y.pageSize().height) && (p(y), s.y = i.top);
            var v = (0, a.assign)({}, s);
            e.startPageNumber = y.pageNumber(), !0 === n.horizontalPageBreak ? function (t, e, n, o) {
              u["default"].calculateAllColumnsCanFitInPage(t, e).map(function (r, i) {
                t.applyStyles(t.userStyles), i > 0 ? g(t, e, n, o, r.columns) : function (t, e, n, o) {
                  var r = e.settings;
        ...
        435: function _(t, e, n) {
          ...
          e["default"] = {
            ...
            calculateAllColumnsCanFitInPage: function calculateAllColumnsCanFitInPage(t, e) {
        ...
        189: function _(t, e, n) {
          ...
          e.calculateWidths = function (t, e) {
                ...
                for (var a = 0, s = e.columns; a < s.length; a++) {
                  ...
                  if (d) {
                    ...
                    if (d.minReadableWidth = f + d.padding("horizontal"), "number" == typeof d.styles.cellWidth) d.minWidth = d.styles.cellWidth, d.wrappedWidth = d.styles.cellWidth;else if ("wrap" === d.styles.cellWidth || !0 === i) d.contentWidth > l ? (d.minWidth = l, d.wrappedWidth = l) : (d.minWidth = d.contentWidth, d.wrappedWidth = d.contentWidth);else {
                      var g = 10 / n;
                      d.minWidth = d.styles.minCellWidth || g, d.wrappedWidth = d.contentWidth, d.minWidth > d.wrappedWidth && (d.wrappedWidth = d.minWidth);
                    }
                  }
                }
            ...
            s && (s = i(n, s, function (t) {
              ...
              return t.minWidth;
            })), s = Math.abs(s), !e.settings.horizontalPageBreak && s > .1 / t.scaleFactor() && (s = s < 1 ? s : Math.round(s), console.error("Of the table content, ".concat(s, " units width could not fit page"))), function (t) {
              ...
              for (var n = {
                ...
                for (var i = r[o], a = 0, s = t.columns; a < s.length; a++) {
                  ...
                  if (d) {
                    ...
                    if ("linebreak" === d.styles.overflow) d.text = e.splitTextToSize(d.text, h + 1 / e.scaleFactor(), {
                      fontSize: d.styles.fontSize
                    });else if ("ellipsize" === d.styles.overflow) d.text = l(d.text, h, d.styles, e, "...");else if ("hidden" === d.styles.overflow) d.text = l(d.text, h, d.styles, e, "");else if ("function" == typeof d.styles.overflow) {
                      var c = d.styles.overflow(d.text, h);
                      d.text = "string" == typeof c ? [c] : c;
                    }
                    d.contentHeight = d.getContentHeight(e.scaleFactor());
                    var f = d.contentHeight / d.rowSpan;
                    d.rowSpan > 1 && n.count * n.height < f * d.rowSpan ? n = {
                      height: f,
                      count: d.rowSpan
                    } : n && n.count > 0 && n.height > f && (f = n.height), f > i.height && (i.height = f);
                  }
                }
                n.count--;
              }
    ...
    return function () {
      ...
      }), t.applyPlugin = d, t.__createTable = function (t, e) {
