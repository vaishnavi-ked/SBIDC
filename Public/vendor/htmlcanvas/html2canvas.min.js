 ...
 */
!function (A, e) {
  "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : (A = "undefined" != typeof globalThis ? globalThis : A || self).html2canvas = e();
}(this, function () {
  "use strict";
  ...
  function A(A, e) {
    ...
    _r2(A, e), A.prototype = null === e ? Object.create(e) : (t.prototype = e.prototype, new t());
  }
  var _h = function h() {
    return (_h = Object.assign || function (A) {
  ...
  function p(A, e, t, r) {
    var B = r[t];
    if (Array.isArray(A) ? -1 !== A.indexOf(B) : A === B) for (var n = t; n <= r.length;) {
      if ((o = r[++n]) === e) return 1;
      if (o !== D) break;
    }
    if (B === D) for (n = t; 0 < n;) {
      var s = r[--n];
      if (Array.isArray(A) ? -1 !== A.indexOf(s) : A === s) for (var o, i = t; i <= r.length;) {
        if ((o = r[++i]) === e) return 1;
        if (o !== D) break;
      }
      if (s !== D) break;
    ...
    return {
      next: function next() {
        ...
        for (var A = tA; i < s && (A = function (A, e, t, r, B) {
          ...
          if (-1 !== [R, X, k, M, S].indexOf(B)) for (var Q = n; 0 <= Q;) {
            if ((c = e[Q]) === R) return tA;
            if (-1 === [X, k].indexOf(c)) break;
            Q--;
          }
          if (-1 !== [P, N].indexOf(B)) for (var c, Q = -1 !== [M, S].indexOf(i) ? s : n; 0 <= Q;) {
            if ((c = e[Q]) === R) return tA;
            if (-1 === [X, k].indexOf(c)) break;
            Q--;
          }
  ...
  function pe(A, t) {
    ...
    for (var i = null, s = 0; s < B.length; s++) {
      var Q = B[s];
      if (null === Q) null === i && (i = s);else if (null !== i) {
  ...
  var Ve,
    ke = {
      "linear-gradient": function linearGradient(t, A) {
        var r = Ce(180),
          B = [];
        return Ae(A).forEach(function (A, e) {
          if (0 === e) {
      ...
      "radial-gradient": function radialGradient(B, A) {
        var n = 0,
          s = 3,
          o = [],
          i = [];
      ...
      "-webkit-gradient": function webkitGradient(r, A) {
        var e = Ce(180),
          B = [],
          n = 1;
        return Ae(A).forEach(function (A, e) {
  ...
  var GB = ["OL", "UL", "MENU"],
    _OB = function OB(e, A, t, r) {
      for (var B = A.firstChild; B; B = s) {
        ...
        PB(B) && 0 < B.data.trim().length ? t.textNodes.push(new zr(e, B, t.styles)) : XB(B) && (rn(B) && B.assignedNodes ? B.assignedNodes().forEach(function (A) {
          return _OB(e, A, t, r);
        }) : (n = VB(e, B)).styles.isVisible() && (RB(B, n, r) ? n.flags |= 4 : NB(n.styles) && (n.flags |= 2), -1 !== GB.indexOf(B.tagName) && (n.flags |= 8), t.elements.push(n), B.slot, B.shadowRoot ? _OB(e, B.shadowRoot, n, r) : en(B) || qB(B) || tn(B) || _OB(e, B, n, r)));
      }
    },
    VB = function VB(A, e) {
    ...
    kB = function kB(A, e) {
      var t = VB(A, e);
      return t.flags |= 4, _OB(A, e, t, t), t;
    },
    RB = function RB(A, e, t) {
  ...
  var _hs = function hs(Q, c, a, g) {
      Q.container.elements.forEach(function (A) {
        ...
        }), B.positiveZIndex.splice(o, 0, t)) : B.zeroOrAutoZIndexOrTransformedOrOpacity.push(t) : (A.styles.isFloating() ? B.nonPositionedFloats : B.nonPositionedInlineLevel).push(t), _hs(r, t, e ? t : a, i)) : ((A.styles.isInlineLevel() ? c.inlineLevel : c.nonInlineLevel).push(r), _hs(r, c, a, i)), Pt(A.flags, 8) && ds(A, i);
      });
    },
    ds = function ds(A, e) {
    ...
    bs = (A(Ds, Ls = he), Ds.prototype.applyEffects = function (A) {
      ...
      return a(this, void 0, void 0, function () {
        ...
        return H(this, function (A) {
          switch (A.label) {
            case 0:
              h = f.styles.backgroundImage.length - 1, e = function e(_e2) {
                var t, r, B, n, s, o, i, Q, c, a, g, w, U, l, C, u, F;
                return H(this, function (A) {
                  switch (A.label) {
                    case 0:
                      if (0 !== _e2.type) return [3, 5];
                      t = void 0, r = _e2.url, A.label = 1;
                    case 1:
                    ...
                    case 5:
                      1 === _e2.type ? (F = Cs(f, h, [null, null, null]), o = F[0], g = F[1], w = F[2], c = F[3], a = F[4], C = Ee(_e2.angle, c, a), l = C[0], B = C[1], i = C[2], u = C[3], Q = C[4], (F = document.createElement("canvas")).width = c, F.height = a, C = F.getContext("2d"), n = C.createLinearGradient(B, u, i, Q), pe(_e2.stops, l).forEach(function (A) {
                        return n.addColorStop(A.stop, ie(A.color));
                      }), C.fillStyle = n, C.fillRect(0, 0, c, a), 0 < c && 0 < a && (s = d.ctx.createPattern(F, "repeat"), d.renderRepeat(o, s, g, w))) : 2 === _e2.type && (u = Cs(f, h, [null, null, null]), o = u[0], i = u[1], Q = u[2], c = u[3], a = u[4], l = 0 === _e2.position.length ? [ge] : _e2.position, g = Ue(l[0], c), w = Ue(l[l.length - 1], a), C = function (A, e, t, r, B) {
                        var n,
                          s,
                          o,
                          i,
                      ...
                      }(_e2, g, w, c, a), F = C[0], u = C[1], 0 < F && 0 < u && (U = d.ctx.createRadialGradient(i + g, Q + w, 0, i + g, Q + w, F), pe(_e2.stops, 2 * F).forEach(function (A) {
      ...
      return a(this, void 0, void 0, function () {
        return H(this, function (A) {
          switch (A.label) {
            case 0:
              return this.options.backgroundColor && (this.ctx.fillStyle = ie(this.options.backgroundColor), this.ctx.fillRect(this.options.x, this.options.y, this.options.width, this.options.height)), t = new as(e = B, null), r = new cs(t), _hs(t, r, r, e = []), ds(t.container, e), [4, this.renderStack(r)];
            case 1:
  ...
  var Js = function Js(u, F) {
      return a(void 0, void 0, void 0, function () {
        var e, t, r, B, n, s, o, i, Q, c, a, g, w, U, l, C;
        return H(this, function (A) {
          switch (A.label) {
            case 0:
              if (!u || "object" != _typeof(u)) return [2, Promise.reject("Invalid element provided as first argument")];
